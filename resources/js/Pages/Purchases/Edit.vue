<script setup>
  ...
  const form = useForm({
    date: dayjs(props.order.created_at).format("YYYY-MM-DD"), 
                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <input type="radio" id="status1" name="status" v-model="form.status" value="1">未キャンセル
                                    <input type="radio" id="status0" name="status" v-model="form.status" value="0">キャンセルする
                                  </div>
                                </div>
